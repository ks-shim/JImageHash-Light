...
import io.github.ksshim.jimagehash.StringUtil;
import io.github.ksshim.jimagehash.graphics.FastPixel;
import io.github.ksshim.jimagehash.hashAlgorithms.DifferenceHash;
...
public class Hash implements Serializable {
	 ...
	 * manner (e.g. {@link DifferenceHash}). In
	 ...
	 * <p>
	 * Some hash algorithms may chose to construct their hashes in a non default
	 * manner (e.g. {@link DifferenceHash}).
	 * 
	 * @param blockSize scaling factor of each pixel in the has. each bit of the
	 *                  hash will be represented to blockSize*blockSize pixels
