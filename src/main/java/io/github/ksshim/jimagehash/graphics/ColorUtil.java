package io.github.ksshim.jimagehash.graphics;

import io.github.ksshim.jimagehash.MathUtil;
...
public class ColorUtil {
	...
	public static Color argbToFXColor(int argb) {
		...
		return new Color(components[1] / 255d, components[2] / 255d, components[3] / 255d,
				components[0] / 255d);
	}
