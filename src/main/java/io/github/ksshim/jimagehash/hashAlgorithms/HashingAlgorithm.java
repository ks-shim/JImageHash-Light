package io.github.ksshim.jimagehash.hashAlgorithms;

import io.github.ksshim.jimagehash.Require;
import io.github.ksshim.jimagehash.graphics.ColorUtil;
import io.github.ksshim.jimagehash.graphics.FastPixel;
import io.github.ksshim.jimagehash.graphics.ImageUtil;
import io.github.ksshim.jimagehash.hash.Hash;
import io.github.ksshim.jimagehash.hashAlgorithms.filter.Filter;
...
public abstract class HashingAlgorithm implements Serializable {
	...
	/**
	 * Add a {@link Filter Filter} to this
	 ...
	 * {@link Hash#toImage(int)} is likely to differ.
	 * 
	 * <p>
