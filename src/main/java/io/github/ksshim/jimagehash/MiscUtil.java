package io.github.ksshim.jimagehash;
...
public class MiscUtil {
	...
	public enum OS {
		...
		WINDOWS("windows"), LINUX("linux"), SOLARIS("sunos", "solaris"), MAC_OS("darwin", "mac", "macos", "mac os x"),
		UNKNOWN("generic"), OTHER(""); // Will always return true
